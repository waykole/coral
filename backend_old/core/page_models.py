"""
Base and abstract pages used in Coral.
"""
...
class CoralPageMeta(PageBase):
    def __init__(cls, name, bases, dct):
        ...
        if 'search_template' not in dct:
            cls.search_template = 'coral/pages/search_result.html'
...
class CoralTag(TaggedItemBase):
    ...
    content_object = ParentalKey('core.CoralPage', related_name='tagged_items')
...
class CoralPage(WagtailCacheMixin, Page, metaclass=CoralPageMeta):
    ...
    index_query_pagemodel = 'core.CoralPage'
...
class CoralWebPage(CoralPage):
    ...
    template = 'coral/pages/web_page.html'
...
class CoralArticlePage(CoralWebPage):
    """
    Article, suitable for news or blog content.
    """
    class Meta:
        verbose_name = _('Coral Article')
        abstract = True

    template = 'coral/pages/article_page.html'
    amp_template = 'coral/pages/article_page.amp.html'
