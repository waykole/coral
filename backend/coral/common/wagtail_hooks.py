...
# from coral.wagtail_flexible_forms.wagtail_hooks import FormAdmin, SubmissionAdmin
...
#     return format_html(
#         '<link rel="stylesheet" type="text/css" href="{}">',
#         static('css/coral-editor.css')
#     )


@hooks.register('insert_editor_js')
def collapsible_js():
    return format_html('<script src="{}"></script>', static('js/coral-editor.js'))
...
#     from coral.models import CoderedFormMixin
#     """
...
# class CoralSubmissionAdmin(SubmissionAdmin):

#     def __init__(self, parent=None):
#         from coral.models import CoderedSessionFormSubmission
...
#         from coral.models import CoderedFormPage, CoderedStreamFormPage
#         actions = []
