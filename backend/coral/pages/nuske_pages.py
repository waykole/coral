...
class CoralNuskaPage(CoralWebPage):
    """
    Dadima ka Nuska and Analysis of medical experts.
    """
    class Meta:
        verbose_name = _('Coral Nuska Page')

    template = 'pages/nuska_page.html'
    amp_template = 'pages/nuska_page.amp.html'
...
class CoralNuskaIndexPage(CoralWebPage):
    """
    Shows a list of nuska sub-pages.
    """
    class Meta:
        verbose_name = _('Coral Nuska Index Page')

    template = 'pages/nuska_index_page.html'
