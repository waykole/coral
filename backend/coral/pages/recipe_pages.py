...
class CoralRecipePage(CoralWebPage):
    """
    Recipe page
    """
    class Meta:
        verbose_name = _('Coral Recipe Page')

    template = 'pages/recipe_page.html'
    amp_template = 'pages/recipe_page.amp.html'
...
class CoralRecipeIndexPage(CoralWebPage):
    """
    Shows a list of recipe sub-pages.
    """
    class Meta:
        verbose_name = _('Coral Recipe Index Page')

    template = 'pages/recipe_index_page.html'
