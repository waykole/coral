...
class CoralQnAPage(CoralWebPage):
    """
    Question and answer page
    """
    class Meta:
        verbose_name = _('Coral QnA Page')

    template = 'pages/qna_page.html'
    amp_template = 'pages/qna_page.amp.html'
...
class CoralQnAIndexPage(CoralWebPage):
    """
    Shows a list of QnA sub-pages.
    """
    class Meta:
        verbose_name = _('Coral QnA Index Page')
